...
Bạn có thể catch up with the talks, or rewatch them, whenever convenient.

### Will the talks be transcribed?

Yes.

### Is there a quy tắc ứng xử?
...
We’ve adopted the [Party Corgi Network’s quy tắc ứng xử][coc].
We will have moderators to ensure that the quy tắc ứng xử is followed.
