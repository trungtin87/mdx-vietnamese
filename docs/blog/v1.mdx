...
It cung cấp the parsing functionality for MDX as a
...
Ví dụ, it cho phép tools like prettier to use the exact same parser used by
MDX core.
...
* React support now yêu cầu `>= 16.8` in `@mdx-js/react`
...
This cho phép us to continually improve the project and spread the workload
...
* Xen kẽ: [#195](https://github.com/mdx-js/mdx/issues/195)
