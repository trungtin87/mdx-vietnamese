...
Bạn có thể update all plugins now.
...
Quan trọng to note when you use your lesser-known but powerful `evaluate`, `run`,
...
There’s also a few small improvements to the Định dạng MDX, some of which
...
Bạn có thể now use modern JavaScript syntax in MDX.
