...
Bài viết này giải thích in short how MDX came to be and why it exists.
...
* HTML is unsafe theo mặc định, so it’s sometimes (partially) unsupported
* HTML and markdown don’t mix well, resulting in confusing rules chẳng hạn như
