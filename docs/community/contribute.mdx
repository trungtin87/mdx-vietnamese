...
Bài viết này giải thích cách đóng góp to MDX.
Vui lòng đọc through the following guidelines.

{/* more */}

<Note type="important">
  **Quan trọng**: before participating in our community, please read our
  [quy tắc ứng xử][coc].
...
If you have questions, see [§ Hỗ trợ][support].
If you can provide financial support, see [§ Tài trợ][sponsor].
...
Bạn có thể run the docs locally, see [¶ Site][site] below.

### Improve issues

Some issues lack information, aren’t reproducible, or are just incorrect.
Bạn có thể help by trying to make them easier to resolve.
