...
It does not support embeds theo mặc định.
...
Bạn có thể use [`@remark-embedder/core`][remark-embedder] by doing something like
this:
...
Bạn có thể use the React-specific [MDX Embed][mdx-embed] to embed things in MDX.
