...
That means math is not supported theo mặc định.
...
<Note type="important">
  **Quan trọng**: if you chose `rehype-katex`, you should also use `katex.css`
...
<Note type="info">
  **Lưu ý:** see also
  ...
  which you can use to support JavaScript expressions inside of math (chẳng hạn như to
