...
<Note type="legacy">
  **Lưu ý**: This is an old migration guide.
  See [§ Di chuyển from v1 to v2](/migrating/v2/).
  The below is kept as is for historical purposes.
</Note>

# Di chuyển from v0 to v1
...
It also cho phép MDXProvider to provide global component scope like a `Youtube`
component.
...
form which cho phép you to customize the merge.
